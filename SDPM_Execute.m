...
% legend('Beardi Discrete Wake','Berardi Semi-Infinite Wake','Gregory, Re = 3 \times 10^7', 'Ladson, Re = 6 \times 10^7', Location='northeast')
% setaxes
% axis padded
% hold off
...
xlabel('X-Coordinate of Airfoil');
ylabel('Coefficient of Pressure (Cp)');
legend('Beardi Discrete Wake','Berardi Semi-Infinite Wake', 'Katz and Plotkin Numerical Diff', Location='northeast')
axis padded
setaxes
hold off
